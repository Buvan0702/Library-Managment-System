...
from lecturer.lecturer_nav import LecturerNavigationFrame
from utils import connect_to_database, center_window

class LecturerDashboard(ctk.CTk):
    def __init__(self, user_id):
        super().__init__()
        self.user_id = user_id
        self.title("Library Management System - Lecturer Dashboard")
        ...
        self.navigation_frame = LecturerNavigationFrame(master=self, signout_command=self.sign_out)
        ...
        self.request_books_frame = RequestBooksFrame(master=self, user_id=self.user_id)
    ...
    def show_frame(self, frame_name):
        ...
        self.request_books_frame.grid_forget()
        ...
        elif frame_name == "request_books":
            self.request_books_frame.grid(row=0, column=1, sticky="nsew")
...
class HomeFrame(ctk.CTkFrame):
    def __init__(self, master, user_info):
        ...
        self.borrowed_count, self.due_soon_count, self.overdue_count = self.get_user_stats()
        ...
        self.request_button = ctk.CTkButton(
            self.actions_frame,
            text="Request Books",
            command=lambda: master.show_frame("request_books"),
            width=150,
            height=40,
            fg_color="#ff9800",
            hover_color="#f57c00"
    ...
    def get_user_stats(self):
        ...
        try:
            ...
            return borrowed_count, due_soon_count, overdue_count
...
class BrowseBooksFrame(ctk.CTkFrame):
    ...
    def borrow_book(self, book):
        ...
        try:
            ...
            # Calculate due date (4 weeks from now for lecturers - longer period)
            borrow_date = datetime.now()
            due_date = borrow_date + timedelta(days=28)  # 4 weeks for lecturers
